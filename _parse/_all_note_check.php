...
if($notes_numrows < 1){
	...
	while ($row = mysqli_fetch_array($query, MYSQLI_ASSOC)) {
		...
		if($note_type == "a"){
			...
			$notification_list .= '<br /> If you encounter any problems, or need help with our system, please contact our Support Team.<br /> Tel: <a href="tel://+2349090606232">09090606232</a> ';
			$notification_list .= '<br /> Emial: <a href="mailto:e-recruiter@gmail.com">noreply@e-recruiter.com</a></h4></div></div>';
		}else if($note_type == "r"){
