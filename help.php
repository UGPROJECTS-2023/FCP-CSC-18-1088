...
<head>
<meta charset="utf-8">
<title>e-Recruiter Support</title>
	    ...
	    <div class="span12">
	      <div class="widget">
			...
			<div class="widget-content">
			  <ol class="faq-list">
				<li>
				  <h4>What is e-Recruiter? How does the system work?</h4>
				  ...
				  <p>e-Recruiter is a job seacrh website that automates the screening and shortlisting processes of recruitment. 
				...
				<!--<li>
				  <h4>Who is behind e-Recruiter?</h4>
				  <p> e-Recruiter is a privately held company with global ambitions and consists of a well seasoned
				  management team and advisors. Kwabena Aboagye Dougan founded this company.</p>	
				</li>-->
				<li>
				  <h4> Is e-Recruiter a recruitment firm?</h4>
				  <p> No. e-Recruiter is NOT a recruitment agency. We do not do candidate interviewing but automate short-listing. 
				...
				<li>
				  <h4>Do I need a PC before i can visit www.e-recruiter.com?</h4>
				  <p> No. You can also access www.e-recruiter.com on your mobile phone. But we strong recommend a PC, just to enhance your experience on the website.</p>	
				</li>
				<li>
				  <h4>What happens when I apply online for jobs posted on www.e-recruiter.com?</h4>
