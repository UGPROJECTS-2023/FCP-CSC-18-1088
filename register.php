...
if(isset($_POST["e"])){	
	...
	if($email == "" || $pass == ""){
        ...
        echo "Password is too short. Try 5 or more characters";
        exit(); 
    } else {		
		$p_hash = md5($pass);
	...
	if($fo == "" || $eo == "" || $po == "" || $userrole == "" || $lo == ""){
		...
		$sql_note = "INSERT INTO notifications (note_type, e_hash, note, date_time) 
										VALUES (
												'a',
												'$eo_hash',
												'Hello $fo. Thanks for joining e-Recruiter. We hope you get excited when you consider the possibilities of landing your dream job. We can not wait for you to get started. You might want to start by:<br>- Tailoring your Profile <br> Your profile is a virtual representation of your physical CV. Make a good one.',
												now())";
	...
	if($r_eo == "" || $company_name == "" || $b_stream == "" || $comp_contact == ""){
		...
		$_note = "INSERT INTO notifications (note_type, e_hash, note, date_time) 
										VALUES (
												'a',
												'$r_eo',
												'Hello $company_name. Thanks for joining e-Recruiter. We hope you get excited when you consider the possibilities of landing the best employees. We can not wait for you to get started. You might want to start by:<br>- Posting a Job',
												now())";
	        ...
	        if(ajaxReturn(ajax) == true) {
	            ...
	            if(text != "success"){
					...
					_("registerform").innerHTML = '	<div class="account-container register">'+
												...
												'	  <label class="rcontainer">Job Seeker'+
												'		<input type="radio" checked name="user_role" id="seeker" value="seeker" onfocus="emptyElement(\'status2\')">'+
