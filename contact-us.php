	...
	<div class="row">
	  ...
	  <div class="span3">
		<div class="contact-section-text">
		  ...
		  <p class="contact-info-text">Direct Dial: +234 909-060-6232</p>
		  <!--<p class="contact-info-text">Toll-Free: 233-20-901-3836</p>
		  <p class="contact-info-text">Fax: 233-20-494-4216</p><br/>-->
		  <p class="contact-info-text"><a href="mailto:contact@e-recruiter.com">contact@e-recruiter.com</a></p>
		</div>
	  </div>
	  <div class="span3">
		<div class="contact-section-text">
		  <p class="contact-info-header-text">SWING BY</p>
		  <p class="contact-info-text">E-recruiter</p>
		  <!--<p class="contact-info-text">230 W Tesano, Achimota Road</p>-->
		  <p class="contact-info-text">Nigeria</p>
		</div>
	  </div>
	</div>
  </div>
