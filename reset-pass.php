...
if(isset($_POST["e"])){	
	...
	if($email == ""){
		...
		$to = "$email";							 
		$from = "noreply@e-recruiter.com";
		$subject = 'E-recruiter Account Forgot Password';
		...
		$message .= '<div style="padding: 20px;background-color: rgb(217, 226, 245);"><a href="http://www.e-recruiter.com/reset&'.$eo_hash.'">Click here to reset password</a></div>';
		$message .= '<br /><br /><br /><span style="font-size:16px;"><b>E-recruiter Security Team</b></span></body></html>';
		$headers = "From: noreply@e-recruiter.com\r\n";
		$headers .= "Reply-To: noreply@e-recruiter.com\r\n";
		$headers .= "Return-Path: noreply@e-recruiter.com\r\n";
		$headers .= "CC: noreply@e-recruiter.com\r\n";
		$headers .= "BCC: noreply@e-recruiter.com\r\n";
