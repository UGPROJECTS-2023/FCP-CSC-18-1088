...
if($user_ok == false){
	header("location: ../ai-recruitment-system");
    exit();
}
?><?php 
										  ...
										  <div class="control-group">											
											...
											<div class="controls">
											  <select name="country" id="country">
												<option value="Nigeria" Selected disabled>Nigeria</option>
											  </select> 
											</div>			
										  </div>
										  <div class="control-group">											
											...
											<div class="controls">
											  <input class="span6" name="phone" id="phone" onkeyup="restrict('phone')" type="text" maxlength="11">
											</div>		
										  </div>
										</div>
