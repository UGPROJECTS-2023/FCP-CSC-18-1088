function chatBot() {
	...
	this.respondTo = function(input) {
		...
		if(this.match('(e-recruiter|about the system|about e-recruiter)'))
			return ["e-Recruiter is a recruitment web-portal that automates the shortlisting process of recruitment. It is intended to help ensure a quality and bias-free selection of candidates, avoid discrimination, save time and money, as well as positively impacting of the organization’s reputation. "];
